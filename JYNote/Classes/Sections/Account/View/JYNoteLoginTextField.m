...
@interface JYNoteLoginTextField ()<UITextFieldDelegate>
...
@implementation JYNoteLoginTextField
...
-(void)moveAnimation:(CGFloat)x y:(CGFloat)y {
    ...
    [UIView animateWithDuration:0.15 animations:^{
        ...
        //        _placeholderLabel.transform = CGAffineTransformMakeRotation(1);
        _moved = YES;
...
-(void)backAnimation:(CGFloat)x y:(CGFloat)y {
    ...
    [UIView animateWithDuration:0.15 animations:^{
        ...
        moveX += padding;
        _placeholderLabel.center = CGPointMake(moveX, moveY);
        //        _placeholderLabel.transform = CGAffineTransformMakeRotation(0);
        _placeholderLabel.alpha = 1;
        _moved = NO;
